...
| `get_history()`          | J.I.        | Complete                    | Return: history array (char\*\*)                                                                         |
| `sigint_handler()`       | J.I.        | Complete                    | Handles SIGINT                                                                                            |
| `get_tokens(line)`       | J.I.        | Waiting                     | Input: Line from getline<br>Output: Tokens                                                                |
...
| `builtin_env()`          | J.I.        | Complete  | Input: command node<br>Return: status                                                                     |
...
| `builtin_history()`      | J.I.        | Complete   | Input: command node<br>Return: status                                                                     |
| `builtin_help()`         | Not Now     | Incomplete - Low Priority   | Input: command node<br>Return: status                                                                     |
| `save_line_to_history()` | J.I.        | Complete   | Input: line, history array                                                                                |
